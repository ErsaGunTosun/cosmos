        ...
        <div className="flex justify-center">
            <div className="relative grid grid-cols-2 bg-white rounded-full p-1 border border-[var(--border)]">
                ...
                <button
                    ...
                    className={`relative z-10 px-4 py-1.5 rounded-full text-sm font-medium transition-colors cursor-pointer ${view === 'elements'
                        ? 'text-white'
                ...
                <button
                    ...
                    className={`relative z-10 px-4 py-1.5 rounded-full text-sm font-medium transition-colors cursor-pointer ${view === 'clusters'
                        ? 'text-white'
                        : 'text-[var(--muted)] hover:text-black'
                        }`}
                >
